...
function SubHeading({ children }: { children: React.ReactNode }) {
  return (
    <h3 className="text-ink text-[18px] font-light tracking-[-0.01em] mt-8 mb-3">
      {children}
    </h3>
  );
}
  ...
  return (
    <ul className="space-y-2.5 my-4">
      {items.map((item, i) => (
        <li
          key={i}
          className="text-ink-mid text-[14px] leading-[1.72] flex items-start gap-3"
        >
...
function InfoBox({ children }: { children: React.ReactNode }) {
  return <div className="bg-parchment-mid p-8 my-8">{children}</div>;
}
      ...
      <table className="w-full text-[14px]">
        <thead>
          <tr className="border-b border-ink/10">
            <th className="text-left text-ink text-[12px] tracking-[0.1em] uppercase py-3 pr-4 font-medium">
              Item
            </th>
            <th className="text-right text-ink text-[12px] tracking-[0.1em] uppercase py-3 font-medium">
              Fee
            </th>
          </tr>
        </thead>
        <tbody>
          {rows.map((row, i) => (
            <tr key={i} className="border-b border-ink/5">
              ...
              <td className="text-ink text-right py-3 font-medium whitespace-nowrap">
                {row.fee}
              </td>
            </tr>
          ))}
...
function NumberedItem({
  ...
  return (
    <div className="flex gap-5 items-start my-6">
      <span className="text-volt text-[28px] font-light leading-none mt-0.5 shrink-0 w-8 text-right">
        {number}
      </span>
      <div>
        <h4 className="text-ink text-[15px] font-medium mb-2">{title}</h4>
        <div className="text-ink-mid text-[14px] leading-[1.72]">
          {children}
        </div>
      </div>
    </div>
...
const MEMBERSHIP_AGREEMENT_SECTIONS: {
...
}[] = [
  {
    id: "release",
    title:
      "Release of liability, assumption of risk, indemnity, and communications consent",
    summary:
      "Risk acceptance, indemnity, equipment liability, and marketing communications consent.",
    blocks: [
      {
        type: "paragraph",
  ...
  },
  {
    ...
    summary:
      "EFT authorization, late payments, collection costs, and billing-company changes.",
    blocks: [
  ...
  },
  {
    ...
    summary:
      "Temporary closures, possible maintenance charges, and holder notice.",
    blocks: [
      {
        type: "paragraph",
  ...
  },
  {
    ...
    summary:
      "Payment, conduct, collection, check-in, and ongoing financial obligations.",
    blocks: [
      {
        type: "bullets",
        items: [
  ...
  },
  {
    ...
    summary:
      "Temporary disability freezes, senior freezes, permanent disability, and freeze fees.",
    blocks: [
      {
        type: "paragraph",
  ...
  },
  {
    ...
    summary:
      "Written notice, refund window, email cancellation, nonrefundable items, death/disability, and WSC cancellation rights.",
    blocks: [
      {
        type: "paragraph",
  ...
  },
  {
    ...
    summary:
      "Facility access, account use, suspension, commercial activity, dress code, conduct, disputes, lockers, photos, and communications.",
    blocks: [
      {
        type: "bullets",
        items: [
  ...
  },
  {
    ...
    summary:
      "Guest access, QR codes, personal training, equipment, panic alarms, behavior, and age requirements.",
    blocks: [
      {
        type: "bullets",
        items: [
  ...
  },
  {
    ...
    summary:
      "WSC modification rights, current guide location, and account-creation acknowledgement.",
    blocks: [
      {
        type: "paragraph",
...
function AgreementBlockView({ block }: { block: AgreementBlock }) {
  if (block.type === "heading") {
    return (
      <h4 className="text-ink text-[14px] tracking-[0.12em] uppercase font-medium pt-3">
        {block.text}
      </h4>
    );
  }
...
function QuickNav({ sections }: { sections: { id: string; label: string }[] }) {
  ...
  return (
    <div className="bg-parchment border-b border-ink/8">
      ...
      <div
        id="policies-quick-nav"
        className={`${open ? "block" : "hidden"} lg:block max-w-[1440px] mx-auto px-6 lg:px-14`}
      >
...
function ClubPoliciesContent() {
  return (
    <>
      ...
      <section
        id="membership"
        className="bg-parchment px-6 lg:px-14 py-24 lg:py-28 scroll-mt-[180px]"
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <p className="text-ink-mid text-[15px] leading-[1.78] mb-8">
            Open each section below to review the complete WSC Member/Passholder
            agreement language.
          </p>
      ...
      <section
        id="court-booking"
        className="bg-parchment-mid px-6 lg:px-14 py-20 lg:py-24 scroll-mt-[180px]"
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              Online booking reservations open daily at 8:00 AM through
              CourtReserve, with a 7-day booking window. Members may select a
              duration of 30, 60, or 90 minutes per session.
            </p>
            <SmallPolicyLink href="/policies/booking-policies-expanded">
              Booking policies expanded
            </SmallPolicyLink>
            <InfoBox>
              <h3 className="text-[18px] font-light tracking-[-0.01em] mb-5">
                Key Booking Rules
              </h3>
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-ink-mid text-[14px] leading-[1.72] mt-1">
                    Members are limited to 3 active reservations within any
                ...
                <div className="border-t border-ink/10 pt-5">
                  ...
                  <p className="text-ink-mid text-[14px] leading-[1.72] mt-1">
                    Members can only book one court at a time — no side-by-side
                    bookings.
                  </p>
                </div>
                <div className="border-t border-ink/10 pt-5">
                  ...
                  <p className="text-ink-mid text-[14px] leading-[1.72] mt-1">
                    The system will not allow bookings that create 30-minute
            ...
            <p>
              All members and guests must check in at the front desk or by using
              the CourtReserve App before going to court. Failure to check in or
              provide complete participant information will result in a full
              court fee.
            </p>
            <SubHeading>USTA Team Reservations</SubHeading>
            <p>
              Visiting teams can only reserve warmup courts the day of the
              match. Home teams can reserve their warmup court up to 7 days in
              advance. USTA fees are $21 + tax per court and include a can of
              Babolat balls.
            </p>
      ...
      <section
        id="cancellation"
        className="bg-parchment px-6 lg:px-14 py-20 lg:py-24 scroll-mt-[180px]"
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <HighlightBox>
              <p className="text-ink text-[15px] leading-[1.72]">
                <strong className="font-medium">24-hour notice</strong> is
                required for court cancellation to receive a balance credit.
                Members are responsible for all no-show or late-canceled court
                fees.
              </p>
            </HighlightBox>
            ...
            <HighlightBox>
              <p className="text-ink text-[15px] leading-[1.72]">
                <strong className="font-medium">7-day notice</strong> prior to
                the start of the session (i.e., Fall 1) is required for
                cancellation of classes, clinics, and camps to receive a
                CourtReserve balance credit. No makeup classes are offered.
              </p>
            </HighlightBox>
            <SubHeading>Private Lesson Cancellation</SubHeading>
            <p>
              Private lessons must be canceled at least 24 hours in advance, or
              you will be charged the full lesson fee. Contact your coach
              directly to cancel.
            </p>
          </Prose>
        </div>
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              All participants in classes, clinics, and private lessons must
              have a valid WSC Pass or Membership.
            </p>
            <SubHeading>Waitlist Policy</SubHeading>
            <HighlightBox>
              <p className="text-ink text-[15px] leading-[1.72]">
                By joining a waitlist, you agree to be{" "}
                <strong className="font-medium">
                  automatically added to the class and charged
                </strong>{" "}
            ...
            <InfoBox>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-ink-mid text-[14px] leading-[1.72] mt-1">
                    Packages expire 31 days after purchase. Unused classes do
                    not roll over.
                  </p>
                </div>
                <div className="border-t border-ink/10 pt-4">
                  <span className="text-ink text-[14px] font-medium">
                    Class Cancellations within a Package
                  </span>
                  <p className="text-ink-mid text-[14px] leading-[1.72] mt-1">
                    Cancel more than 48 hours in advance to return the class to
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            <p>
              WSC members are welcome to bring guests. Payment of the applicable
              guest fee is required before using the facility, and the member
              must be present.
            </p>
            <FeeTable
              rows={[
                {
                  item: "Tennis Guest Fee",
                  fee: "$10 + tax / guest / reservation",
                },
                {
                  item: "Pickleball Guest Fee",
                  fee: "$5 + tax / guest / reservation",
                },
              ]}
            />
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              Outside ball machines and ball hoppers are prohibited on WSC
              courts. Rental baskets of Babolat balls are available for $15 +
              tax. The Playmate Smash ball machine remains available for rent on
              courts #7 and #8.
            </p>
            <SubHeading>Footwear Requirements</SubHeading>
            <p>
              Court shoes specifically designed for tennis or pickleball must be
              worn on court — no sneakers or running shoes.
            </p>
          </Prose>
        </div>
      </section>
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              WSC may be temporarily closed for up to two (2) weeks each year
              for maintenance purposes.
            </p>
            <SubHeading>Lockers</SubHeading>
            <p>
              Lockers are for day use only. Members are responsible for
              providing their own lock. WSC is not responsible for lost or
              stolen items.
            </p>
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            <p>
              Effective January 1, 2025. Pricing is no longer tax inclusive. WSC
              reserves the right to update fees with appropriate notice.
            </p>
            <FeeTable
              rows={[
                { item: "Court Time (per 30 minutes)", fee: "$21.14 + tax" },
                {
                  item: "Tennis Guest Fee (per reservation)",
                  fee: "$10 + tax",
                },
                {
                  item: "Pickleball Guest Fee (per reservation)",
                  fee: "$5 + tax",
                },
                { item: "Ball Basket Rental (Babolat)", fee: "$15 + tax" },
                {
                  item: "USTA Team Fee (per court, includes balls)",
                  fee: "$21 + tax",
                },
              ]}
            />
            <HighlightBox>
              <p className="text-ink text-[15px] leading-[1.72]">
                <strong className="font-medium">Questions about fees?</strong>{" "}
    ...
    <>
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              ...
              Woodinville Sports Club ("WSC") website at{" "}
              <strong className="text-ink font-normal">
                woodinvillesportsclub.com
              </strong>
              , our facilities at 15327 140th Pl NE, Woodinville, WA 98072, and
              all related services, programs, memberships, and activities.
            </p>
            <p>
              By accessing our Site, purchasing a membership, booking a
              facility, or using our services, you acknowledge that you have
              read, understood, and agree to be bound by these Terms. These
              Terms are supplementary to any additional program-specific terms
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              WSC offers several membership tiers, including the Family
              All-Access Pass (monthly), Court & Range Access Pass (annual), and
              Class Registration Pass (annual). Complete details are on our{" "}
              <Link
                href="/membership"
                className="text-ink underline underline-offset-4 decoration-volt"
              >
                Membership page
              </Link>
              .
            ...
            <HighlightBox>
              <p className="text-ink-mid text-[14px] leading-[1.7]">
                ...
                Memberships are non-transferable and may not be shared, sold, or
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              All reservations, registrations, and enrollments are managed
              through CourtReserve. Members are responsible for maintaining
            ...
            <InfoBox>
              <div className="space-y-5">
                <NumberedItem
                  number="1"
                  title="Court Reservations (Tennis, Pickleball)"
                >
                  <p>
                    Cancel at least 12 hours before reserved time. Three
                    consecutive no-shows within 30 days may result in booking
                    restrictions.
                  </p>
                </NumberedItem>
                ...
                <NumberedItem number="2" title="Swing Lab Simulators">
                  <p>
                    Cancel at least 4 hours before reserved time. Late
                    cancellations charged full rental fee.
                  </p>
                </NumberedItem>
                <div className="border-t border-ink/10" />
                <NumberedItem number="3" title="Classes & Group Programs">
                  <p>
                    Cancel at least 24 hours before class start time. Waitlisted
                    participants notified automatically.
                  </p>
                </NumberedItem>
                <div className="border-t border-ink/10" />
                <NumberedItem
                  number="4"
                  title="Summer Camps & Multi-Week Programs"
                >
                  <p>
                    Full refund up to 14 days before start. 50% refund within 14
                    days. No refunds after program begins.
                  </p>
                </NumberedItem>
              </div>
            </InfoBox>
            ...
            <p>
              WSC may close facilities or cancel outdoor activities without
              prior notice in severe weather. Affected reservations will be
              credited or rescheduled. Indoor facilities operate on normal
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              Participation in sports and fitness activities at WSC involves
              inherent risks of physical injury. By using WSC facilities or
              participating in any program, you voluntarily assume all risks
              associated with such activities.
            </p>
            <HighlightBox>
              <p className="text-ink text-[15px] font-medium mb-3">
                Waiver and Release of Liability
              </p>
              <p className="text-ink-mid text-[14px] leading-[1.72]">
                In consideration of being permitted to use the facilities, you
                agree to release, waive, and discharge WSC, its officers,
                directors, employees, and affiliates from any and all liability
                arising out of your participation, to the fullest extent
                permitted by Washington State law (RCW 4.24.210).
              </p>
            </HighlightBox>
            <SubHeading>Minors</SubHeading>
            <p>
              For participants under 18, a parent or legal guardian must sign
              the liability waiver on behalf of the minor.
            </p>
            <SubHeading>Medical Conditions</SubHeading>
            <p>
              Members are responsible for disclosing any medical conditions that
              may affect their ability to safely participate. Consult your
              physician before engaging in physical activity at WSC.
            </p>
          </Prose>
        </div>
      </section>
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            <p>
              WSC is committed to maintaining a safe, respectful, and inclusive
              environment for all members, guests, staff, and visitors.
            </p>
            ...
            <HighlightBox>
              <p className="text-ink-mid text-[14px] leading-[1.7]">
                <strong className="text-ink font-normal">Enforcement:</strong>{" "}
                Violations may result in verbal warning, written warning,
                temporary suspension, or permanent termination of membership, at
                WSC management's sole discretion.
              </p>
            </HighlightBox>
          </Prose>
        </div>
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              Registration for all programs is managed through CourtReserve.
              Availability, schedules, and pricing are subject to change. In the
              event of a cancellation by WSC, registered participants will
              receive a full refund or credit.
            </p>
            <SubHeading>Tier 1 Sports</SubHeading>
            <p>
              WSC is home to Tier 1 Sports, one of the nation's leading
              developmental programs. Tier 1 programs may have additional terms
              and fee structures. Enrollment is subject to evaluation by Tier 1
              coaching staff.
            </p>
            <SubHeading>Summer Camps</SubHeading>
            <p>
              Summer training programs (Tennis Academy, Golf Academy, Adventure
              Club) are available for ages 3–18. Parents must complete all
              required registration forms, medical disclosures, and liability
              waivers before the first day.
            </p>
          </Prose>
        </div>
      </section>
      ...
      >
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              All content on the WSC website is the property of Woodinville
              Sports Club and is protected by U.S. and international copyright
            ...
            <p>
              ...
              CourtReserve and Tier 1 Sports. WSC does not endorse or assume
              responsibility for third-party content.
            </p>
            <SubHeading>Disclaimer of Warranties</SubHeading>
            <p>
              The Site and all content are offered on an "as is" and "as
              available" basis without warranties of any kind. WSC does not
              warrant that the Site will be uninterrupted, error-free, or
              secure.
            </p>
            <SubHeading>Limitation of Liability</SubHeading>
            <p>
              To the fullest extent permitted by law, WSC shall not be liable
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <Prose>
            ...
            <p>
              ...
              Washington. Legal proceedings shall be brought exclusively in King
              County, Washington courts.
            </p>
            <SubHeading>Dispute Resolution</SubHeading>
            <p>
              Before initiating legal proceedings, you agree to first attempt
              ...
              . If unresolved within 30 days, either party may pursue binding
              arbitration through the AAA in King County, Washington.
            </p>
            ...
            <p>
              WSC reserves the right to modify these Terms at any time. Material
              changes will be communicated at least 30 days before taking
              effect.
            </p>
            <SubHeading>Force Majeure</SubHeading>
            <p>
              WSC shall not be liable for failure to perform due to
              circumstances beyond its reasonable control, including natural
              disasters, pandemics, government orders, or acts of terrorism.
            </p>
          </Prose>
...
export default function Policies() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <StructuredData
        schemas={[
          getBreadcrumbSchema([
            ...
            {
              name: "Policies & Terms",
              url: "https://www.woodinvillesportsclub.com/policies",
            },
          ]),
        ]}
      />
      ...
      {/* Tab Switcher */}
      <div className="bg-dark-bg sticky top-[var(--site-header-height,130px)] z-30 border-b border-white/[0.08]">
        <div
          className="max-w-[1440px] mx-auto px-6 lg:px-14 flex overflow-x-auto"
          role="group"
      ...
      <section className="bg-dark-bg px-6 lg:px-14 py-20 lg:py-24">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <p className="text-parchment/80 text-[15px] leading-[1.72] mb-10 max-w-[500px] mx-auto">
            If you have questions about any of our policies or terms, please
          ...
          <p className="text-parchment/70 text-[12px] mt-8">
            Policies last updated September 14, 2025. Terms last updated March
            4, 2026.
          </p>
        </div>
      </section>
